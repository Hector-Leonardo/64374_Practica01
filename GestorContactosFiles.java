...
public class GestorContactosFiles {
    ...
    private static void modificarContacto() {
        ...
        try {
            ...
            for (int i = 0; i < lineas.length; i++) {
                ...
                todasLasLineas.add(lineas[i]);
                if (partes.length == 2 && partes[0].toLowerCase().contains(nombreBuscado.toLowerCase())) {
                    coincidencias.add(new String[]{partes[0], partes[1], String.valueOf(i)});
                }
            }
            ...
            System.out.print("Ingrese el nuevo nombre (Enter para mantener \"" + contactoSeleccionado[0] + "\"): ");
            String nuevoNombre = scanner.nextLine();
            if (nuevoNombre.trim().isEmpty()) {
                nuevoNombre = contactoSeleccionado[0];
            }

            System.out.print("Ingrese el nuevo teléfono (Enter para mantener \"" + contactoSeleccionado[1] + "\"): ");
